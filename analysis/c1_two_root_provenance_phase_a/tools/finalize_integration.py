...
def expected_manifest(root: Path, source_zip_sha256: str) -> dict[str, object]:
    ...
    return {
        ...
        "authority": {
            ...
            "integration_base_sha": "0200beede923c56e0284d9555c1dabaf91fa1755",
            "integration_base_tree": "23f10c12181c5caa394f7a3fb1acb6e79cc02fe6",
            "project": "PAUSED",
            "active_promoted_route": "NONE",
            "a303656": "UNRESOLVED",
        },
        "source": {
            "requested_filename": "A303656_TWO_ROOT_PROVENANCE_PHASE_A(1).zip",
            "located_filename": "A303656_TWO_ROOT_PROVENANCE_PHASE_A.zip",
...
def main() -> int:
    ...
    source_hash = "42f6c80a2c7c887ad89268e20a6f2e4068a914c6b0410c3db959b1d40473b42f"
