...
DESTINATION = 'analysis/c1_seven_basin_global_shared_state_phase_e/'
REQUIRED = ['EXACTLY-SEVEN STATE-COMPATIBILITY / O31 AUTHORITY', 'prescribed actual exactly-seven arithmetic normal form', 'allowing legal K/E to be chosen', 'not an arbitrary frozen seven-root ledger', 'exactly-seven not excluded', 'N>=8: NOT PROVED']
