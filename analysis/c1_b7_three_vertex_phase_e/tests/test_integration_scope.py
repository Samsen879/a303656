...
DESTINATION = 'analysis/c1_b7_three_vertex_phase_e/'
REQUIRED = ['CONCRETE 48-INDEX B7 ARITHMETIC AUTHORITY', '12/48 indices are closed', '903 and 1806 remain OPEN', 'three-vertex B7 empty: NOT PROVED', 'actual B7 member: NONE', 'N>=8: NOT PROVED']
