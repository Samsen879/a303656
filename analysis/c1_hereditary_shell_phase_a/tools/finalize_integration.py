...
def expected_manifest(root: Path, source_zip_sha256: str) -> dict[str, object]:
    ...
    return {
        ...
        "source": {
            "requested_filename": "A303656_HEREDITARY_SHELL_PHASE1(1).zip",
            "located_filename": "A303656_HEREDITARY_SHELL_PHASE1.zip",
...
def main() -> int:
    ...
    source_hash = "0e2cbeb8b226dee16b44cc0783a07e45da57d7738ad924af1503337f9d2d0fde"
