...
def expected_manifest(root: Path, source_zip_sha256: str) -> dict[str, object]:
    ...
    return {
        ...
        "source": {
            "requested_filename": "A303656_TWO_ANCHOR_SYNC_PHASE_A.zip",
            "located_filename": "A303656_TWO_ANCHOR_SYNC_PHASE_A.zip",
...
def main() -> int:
    ...
    source_hash = "8b8b519014833f9311e7f1d158c0d6d115b598a06d15893e44d04d984943ce4e"
