...
def expected_manifest(root: Path, source_zip_sha256: str) -> dict[str, object]:
    ...
    return {
        ...
        "source": {
            "requested_filename": "A303656_KRAFT_HALL_PHASE_A.zip",
            "located_filename": "A303656_KRAFT_HALL_PHASE_A.zip",
...
def main() -> int:
    ...
    source_hash = "46ddff326095b284a38d912315e3db11c4b20fce13049c0e4d820e63ec75f1a5"
