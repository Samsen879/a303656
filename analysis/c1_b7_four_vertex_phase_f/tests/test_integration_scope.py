...
DESTINATION = "analysis/c1_b7_four_vertex_phase_f/"
REQUIRED = ["15 proper states and 120 distinct terminal indices, EXHAUSTIVE", "28 certified proper states and 448 terminal indices, NOT EXHAUSTIVE", "complete four-vertex exclusions: 0", "actual B7 member: NONE", "all four-vertex B7 closed: NO"]
...
class IntegrationScopeTests(unittest.TestCase):
    ...
    def test_package_scope_guards(self):
        for statement in REQUIRED:
            self.assertIn(statement, self.integration)
        self.assertEqual(self.binding["reconciliation_receipts"]["FOUR_VERTEX_CLASSIFICATION_RECONCILIATION"], "PASS")
