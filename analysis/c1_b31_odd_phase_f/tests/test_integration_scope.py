...
DESTINATION = "analysis/c1_b31_odd_phase_f/"
REQUIRED = [
    "O31_SOURCE_RECONCILIATION: PASS",
    "B31^odd empty: NO",
...
class IntegrationScopeTests(unittest.TestCase):
    ...
    def test_package_scope_guards(self):
        for statement in REQUIRED:
            self.assertIn(statement, self.integration)
        self.assertIn("prescribed actual exactly-seven arithmetic normal form", self.binding["reconciliation_receipts"]["scope"].lower())
