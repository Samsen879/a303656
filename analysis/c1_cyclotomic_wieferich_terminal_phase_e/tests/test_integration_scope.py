...
DESTINATION = 'analysis/c1_cyclotomic_wieferich_terminal_phase_e/'
REQUIRED = ['CYCLOTOMIC VALUATION NORMALIZATION', 'New excluded indices: NONE', 'derivative shortcut is invalid', 'Variable-base countermodels are not base-5 project examples', 'B7 empty: NOT PROVED']
