#!/usr/bin/env python3
"""Fail-closed recursive validator for the A303656 Master V2 candidate."""
...
def validate(path):
    ...
    exact={'master_authority_v2':'CANDIDATE — PENDING INDEPENDENT WEB FREEZE AUDIT','project':'PAUSED','active_promoted_route':'NONE','low_cost_generic_theorem_hunts':'NOT ACTIVE','targeted_restart':'ONLY ON EXPLICIT RESTART GATE','codex_large_scale_research':'NOT AUTHORIZED','codex_ultra':'NOT AUTHORIZED','a303656':'UNRESOLVED'}
    ...
    return {'schema':'a303656-master-v2-recursive-validation-v1','verdict':'PASS' if not errors else 'FAIL','validator_scope':'Artifact, ledger, custody, manifest, recursive archive, and governance consistency; not independent proof validation.','errors':errors,'warnings':warnings,'statistics':dict(stats)}
